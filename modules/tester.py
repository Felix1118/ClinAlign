...
class Tester(BaseTester):
    ...
    def test_blip(self):
        ...
        self.model.eval()
        with torch.no_grad():
            test_gts, test_res ,test_file_path= [], [],[]
            for batch_idx, (images, captions, cls_labels, clip_memory, image_path) in enumerate(self.test_dataloader):
                ...
                test_file_path.extend(image_path)
                if batch_idx % 1 == 0:
